...
#SBATCH --partition=smallcard # smallcard | midcard | dualcard | bigcard
...
#SBATCH --mem-per-cpu=12G         # (12G) (30G) (72G) memory per cpu-core - unless you're doing something obscene the default here is fine. This is RAM, not VRAM, so it's like storage for your dataset
